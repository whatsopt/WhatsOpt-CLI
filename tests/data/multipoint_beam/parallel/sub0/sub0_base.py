...
class Sub0Base(Group):
    ...
    def setup(self): 
        ...
        self.add_subsystem('StatesComp', self.create_states_comp(), promotes=['d_0', 'd_1', 'K_local'])
        self.add_subsystem('DisplacementsComp', self.create_displacements_comp(), promotes=['displacements_0', 'displacements_1', 'd_0', 'd_1'])
        self.add_subsystem('ComplianceComp', self.create_compliance_comp(), promotes=['compliance_0', 'compliance_1', 'displacements_0', 'displacements_1'])
